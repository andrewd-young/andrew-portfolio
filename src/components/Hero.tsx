      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <div className="flex space-x-4">
            <a
              href="https://github.com/andrewd-young"
            ...
            <a
              href="mailto:andrewy445@gmail.com"
              className="px-4 py-2 rounded-full border border-gray-300 dark:border-gray-700 
                        text-gray-600 dark:text-gray-400 
                        hover:border-gray-900 dark:hover:border-gray-300 
                        hover:text-gray-900 dark:hover:text-white 
          ...
          <div className="grid grid-cols-4 gap-4 mt-12">
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/30 transition-all duration-300">
                <span className="text-white font-medium transform translate-y-8 group-hover:translate-y-0 transition-transform duration-300">
                  Sound Coven
                </span>
              </div>
            </a>
            ...
            <a
              href="#summit"
              className="h-24 rounded-xl transition-all duration-300 cursor-pointer relative group overflow-hidden"
            ...
            {/* Lola Dating */}
            <div
              className="h-24 col-span-2 rounded-xl transition-all duration-300 cursor-pointer relative group overflow-hidden"
